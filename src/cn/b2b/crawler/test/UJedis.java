...
public class UJedis {
		...
		if (redis_servers == null) {
			...
			for (String s : pls) {
				if (s != null) {
					...
					try {
						InetAddress  myServer = InetAddress.getByName(host);
						host = myServer.getHostAddress();
					} catch (UnknownHostException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
					System.out.println(host+" "+port);
					JedisShardInfo sd = new JedisShardInfo(host, Integer.valueOf(port));
					servers.add(sd);
				}
			}
		}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		*/
		...
		String val = UJedis.get("crawler:http://yibang0755.1688.com/page/creditdetail.htm tracelog=p4p");
